...
-   **1st Place at Each Year Level**: TBD <!-- \$300 split between team members. -->
...
| csv       | [traindata.csv](data/testdata.csv) | [evaldata.csv](data/evaldata.csv) |
| dta       | [traindata.dta](data/testdata.dta) | [evaldata.dta](data/evaldata.dta) |
...
All submissions must be in **.csv** format, and contain only two columns: 1) **rec_num**, the numeric ID number for the municipality; 2) **phrlyearn**, the prediction of immigration levels for that municipality.
...
Submit your .csv files here: link to submission form <!-- [link to submission form](https://forms.gle/azMhqbfM1xNsiK546) -->
